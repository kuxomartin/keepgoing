...
export const mockFoodLogs: FoodLog[] = [
  { id: 'f-1',  user_id: 'demo', date: d(0), eaten_at: dt(0, 8),  meal_type: 'breakfast', description: 'Oats with banana and honey', estimated_calories: 380, protein_g: 12, carbs_g: 68, fat_g: 6, confidence: 'high', digestion_note: null, image_url: null, source: null, created_at: dt(0, 8) },
  { id: 'f-2',  user_id: 'demo', date: d(0), eaten_at: dt(0, 13), meal_type: 'lunch', description: 'Chicken breast, rice, broccoli', estimated_calories: 520, protein_g: 42, carbs_g: 55, fat_g: 10, confidence: 'high', digestion_note: null, image_url: null, source: null, created_at: dt(0, 13) },
  { id: 'f-3',  user_id: 'demo', date: d(0), eaten_at: dt(0, 19), meal_type: 'dinner', description: 'Salmon, sweet potato, salad', estimated_calories: 620, protein_g: 38, carbs_g: 52, fat_g: 18, confidence: 'medium', digestion_note: null, image_url: null, source: null, created_at: dt(0, 19) },
  { id: 'f-4',  user_id: 'demo', date: d(1), eaten_at: dt(1, 8),  meal_type: 'breakfast', description: 'Scrambled eggs on sourdough toast', estimated_calories: 430, protein_g: 24, carbs_g: 42, fat_g: 16, confidence: 'high', digestion_note: null, image_url: null, source: null, created_at: dt(1, 8) },
  { id: 'f-5',  user_id: 'demo', date: d(1), eaten_at: dt(1, 11), meal_type: 'snack', description: 'Energy bar on the bike', estimated_calories: 220, protein_g: 5, carbs_g: 44, fat_g: 4, confidence: 'medium', digestion_note: null, image_url: null, source: null, created_at: dt(1, 11) },
  { id: 'f-6',  user_id: 'demo', date: d(1), eaten_at: dt(1, 14), meal_type: 'lunch', description: 'Protein shake + banana', estimated_calories: 350, protein_g: 32, carbs_g: 38, fat_g: 6, confidence: 'high', digestion_note: null, image_url: null, source: null, created_at: dt(1, 14) },
  { id: 'f-7',  user_id: 'demo', date: d(1), eaten_at: dt(1, 20), meal_type: 'dinner', description: 'Pasta bolognese (large portion)', estimated_calories: 780, protein_g: 35, carbs_g: 98, fat_g: 22, confidence: 'low', digestion_note: null, image_url: null, source: null, created_at: dt(1, 20) },
  { id: 'f-8',  user_id: 'demo', date: d(3), eaten_at: dt(3, 8),  meal_type: 'breakfast', description: 'Greek yogurt, granola, berries', estimated_calories: 340, protein_g: 18, carbs_g: 48, fat_g: 8, confidence: 'high', digestion_note: null, image_url: null, source: null, created_at: dt(3, 8) },
  { id: 'f-9',  user_id: 'demo', date: d(3), eaten_at: dt(3, 13), meal_type: 'lunch', description: 'Tuna salad with wholegrain bread', estimated_calories: 460, protein_g: 36, carbs_g: 45, fat_g: 12, confidence: 'medium', digestion_note: null, image_url: null, source: null, created_at: dt(3, 13) },
  { id: 'f-10', user_id: 'demo', date: d(3), eaten_at: dt(3, 20), meal_type: 'dinner', description: 'Steak, green beans, mashed potato', estimated_calories: 680, protein_g: 45, carbs_g: 48, fat_g: 20, confidence: 'medium', digestion_note: 'Felt heavy after', image_url: null, source: null, created_at: dt(3, 20) },
]
