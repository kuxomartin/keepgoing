...
export const mockHealthMetrics: HealthMetrics[] = [
  { id: 'm-1',  user_id: 'demo', date: d(0),  sleep_minutes: 430, deep_sleep_minutes: 80,  rem_sleep_minutes: 95,  resting_hr: 54, hrv_ms: 68, vo2max: 52.1, steps: 9200,  active_energy_kcal: 580, respiratory_rate: 14.2, source: 'mock', source_payload: null, created_at: dt(0) },
  { id: 'm-2',  user_id: 'demo', date: d(1),  sleep_minutes: 385, deep_sleep_minutes: 65,  rem_sleep_minutes: 80,  resting_hr: 58, hrv_ms: 52, vo2max: 52.1, steps: 7400,  active_energy_kcal: 420, respiratory_rate: 14.8, source: 'mock', source_payload: null, created_at: dt(1) },
  { id: 'm-3',  user_id: 'demo', date: d(2),  sleep_minutes: 465, deep_sleep_minutes: 95,  rem_sleep_minutes: 110, resting_hr: 52, hrv_ms: 74, vo2max: 52.1, steps: 11800, active_energy_kcal: 720, respiratory_rate: 13.9, source: 'mock', source_payload: null, created_at: dt(2) },
  { id: 'm-4',  user_id: 'demo', date: d(3),  sleep_minutes: 410, deep_sleep_minutes: 70,  rem_sleep_minutes: 90,  resting_hr: 55, hrv_ms: 61, vo2max: 52.1, steps: 8500,  active_energy_kcal: 510, respiratory_rate: 14.5, source: 'mock', source_payload: null, created_at: dt(3) },
  { id: 'm-5',  user_id: 'demo', date: d(4),  sleep_minutes: 340, deep_sleep_minutes: 55,  rem_sleep_minutes: 70,  resting_hr: 63, hrv_ms: 44, vo2max: 52.1, steps: 6100,  active_energy_kcal: 380, respiratory_rate: 15.2, source: 'mock', source_payload: null, created_at: dt(4) },
  { id: 'm-6',  user_id: 'demo', date: d(5),  sleep_minutes: 490, deep_sleep_minutes: 100, rem_sleep_minutes: 120, resting_hr: 51, hrv_ms: 79, vo2max: 52.1, steps: 12500, active_energy_kcal: 780, respiratory_rate: 13.6, source: 'mock', source_payload: null, created_at: dt(5) },
  { id: 'm-7',  user_id: 'demo', date: d(6),  sleep_minutes: 450, deep_sleep_minutes: 88,  rem_sleep_minutes: 105, resting_hr: 53, hrv_ms: 71, vo2max: 52.1, steps: 10200, active_energy_kcal: 640, respiratory_rate: 14.1, source: 'mock', source_payload: null, created_at: dt(6) },
  { id: 'm-8',  user_id: 'demo', date: d(7),  sleep_minutes: 395, deep_sleep_minutes: 68,  rem_sleep_minutes: 85,  resting_hr: 57, hrv_ms: 56, vo2max: 52.1, steps: 8900,  active_energy_kcal: 550, respiratory_rate: 14.6, source: 'mock', source_payload: null, created_at: dt(7) },
  { id: 'm-9',  user_id: 'demo', date: d(8),  sleep_minutes: 420, deep_sleep_minutes: 75,  rem_sleep_minutes: 95,  resting_hr: 55, hrv_ms: 64, vo2max: 52.1, steps: 9600,  active_energy_kcal: 600, respiratory_rate: 14.3, source: 'mock', source_payload: null, created_at: dt(8) },
  { id: 'm-10', user_id: 'demo', date: d(9),  sleep_minutes: 480, deep_sleep_minutes: 92,  rem_sleep_minutes: 115, resting_hr: 52, hrv_ms: 76, vo2max: 52.1, steps: 11200, active_energy_kcal: 700, respiratory_rate: 13.8, source: 'mock', source_payload: null, created_at: dt(9) },
  { id: 'm-11', user_id: 'demo', date: d(10), sleep_minutes: 360, deep_sleep_minutes: 58,  rem_sleep_minutes: 75,  resting_hr: 61, hrv_ms: 47, vo2max: 52.1, steps: 6800,  active_energy_kcal: 410, respiratory_rate: 15.0, source: 'mock', source_payload: null, created_at: dt(10) },
  { id: 'm-12', user_id: 'demo', date: d(11), sleep_minutes: 445, deep_sleep_minutes: 85,  rem_sleep_minutes: 100, resting_hr: 54, hrv_ms: 69, vo2max: 52.1, steps: 10500, active_energy_kcal: 660, respiratory_rate: 14.2, source: 'mock', source_payload: null, created_at: dt(11) },
  { id: 'm-13', user_id: 'demo', date: d(12), sleep_minutes: 415, deep_sleep_minutes: 72,  rem_sleep_minutes: 92,  resting_hr: 56, hrv_ms: 60, vo2max: 52.1, steps: 8800,  active_energy_kcal: 540, respiratory_rate: 14.4, source: 'mock', source_payload: null, created_at: dt(12) },
  { id: 'm-14', user_id: 'demo', date: d(13), sleep_minutes: 500, deep_sleep_minutes: 105, rem_sleep_minutes: 125, resting_hr: 50, hrv_ms: 82, vo2max: 52.1, steps: 13100, active_energy_kcal: 810, respiratory_rate: 13.5, source: 'mock', source_payload: null, created_at: dt(13) },
]
...
export const mockFoodLogs: FoodLog[] = [
  { id: 'f-1',  user_id: 'demo', date: d(0), meal_type: 'breakfast', description: 'Oats with banana and honey', estimated_calories: 380, protein_g: 12, carbs_g: 68, fat_g: 6, confidence: 'high', digestion_note: null, image_url: null, created_at: dt(0, 8) },
  { id: 'f-2',  user_id: 'demo', date: d(0), meal_type: 'lunch', description: 'Chicken breast, rice, broccoli', estimated_calories: 520, protein_g: 42, carbs_g: 55, fat_g: 10, confidence: 'high', digestion_note: null, image_url: null, created_at: dt(0, 13) },
  { id: 'f-3',  user_id: 'demo', date: d(0), meal_type: 'dinner', description: 'Salmon, sweet potato, salad', estimated_calories: 620, protein_g: 38, carbs_g: 52, fat_g: 18, confidence: 'medium', digestion_note: null, image_url: null, created_at: dt(0, 19) },
  { id: 'f-4',  user_id: 'demo', date: d(1), meal_type: 'breakfast', description: 'Scrambled eggs on sourdough toast', estimated_calories: 430, protein_g: 24, carbs_g: 42, fat_g: 16, confidence: 'high', digestion_note: null, image_url: null, created_at: dt(1, 8) },
  { id: 'f-5',  user_id: 'demo', date: d(1), meal_type: 'snack', description: 'Energy bar on the bike', estimated_calories: 220, protein_g: 5, carbs_g: 44, fat_g: 4, confidence: 'medium', digestion_note: null, image_url: null, created_at: dt(1, 11) },
  { id: 'f-6',  user_id: 'demo', date: d(1), meal_type: 'lunch', description: 'Protein shake + banana', estimated_calories: 350, protein_g: 32, carbs_g: 38, fat_g: 6, confidence: 'high', digestion_note: null, image_url: null, created_at: dt(1, 14) },
  { id: 'f-7',  user_id: 'demo', date: d(1), meal_type: 'dinner', description: 'Pasta bolognese (large portion)', estimated_calories: 780, protein_g: 35, carbs_g: 98, fat_g: 22, confidence: 'low', digestion_note: null, image_url: null, created_at: dt(1, 20) },
  { id: 'f-8',  user_id: 'demo', date: d(3), meal_type: 'breakfast', description: 'Greek yogurt, granola, berries', estimated_calories: 340, protein_g: 18, carbs_g: 48, fat_g: 8, confidence: 'high', digestion_note: null, image_url: null, created_at: dt(3, 8) },
  { id: 'f-9',  user_id: 'demo', date: d(3), meal_type: 'lunch', description: 'Tuna salad with wholegrain bread', estimated_calories: 460, protein_g: 36, carbs_g: 45, fat_g: 12, confidence: 'medium', digestion_note: null, image_url: null, created_at: dt(3, 13) },
  { id: 'f-10', user_id: 'demo', date: d(3), meal_type: 'dinner', description: 'Steak, green beans, mashed potato', estimated_calories: 680, protein_g: 45, carbs_g: 48, fat_g: 20, confidence: 'medium', digestion_note: 'Felt heavy after', image_url: null, created_at: dt(3, 20) },
]
