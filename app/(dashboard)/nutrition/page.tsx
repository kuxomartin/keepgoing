...
export default async function NutritionPage() {
  ...
  // Index health metrics by date (best source wins — take last for each date)
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4 text-center mb-4">
            ...
            <div>
              ...
              {todayActive != null && <p className="text-xs text-gray-400">{fmtKcal(todayActive)} active</p>}
            </div>
            <div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              { label: 'Avg balance',   value: avgBalance != null ? `${avgBalance > 0 ? '+' : ''}${fmtKcal(avgBalance)}` : '—', sub: 'kcal / day', color: avgBalance != null && avgBalance > 150 ? 'text-red-600' : avgBalance != null && avgBalance < -800 ? 'text-orange-600' : 'text-gray-900' },
                ...
                {[...dates].reverse().map(date => {
                  ...
                  return (
                    <tr key={date} className={isToday ? 'bg-blue-50/50' : 'hover:bg-gray-50'}>
                      ...
                      <td className={cn('px-5 py-3 text-right font-semibold', bal != null ? textColor : 'text-gray-300')}>
